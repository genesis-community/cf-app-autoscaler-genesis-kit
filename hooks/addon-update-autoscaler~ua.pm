...
package Genesis::Hook::Addon::AppAutoscaler::UpdateAutoscaler v4.0.0;
...
sub cmd_details {
  return
  "Updates the Autoscaler service broker information to your deployed CF.\n";
}
...
sub perform {
  ...
  run("cf update-service-broker autoscaler \"$username\" \"$password\" \"$url\"");

  info("\n#G{[OK]} Successfully updated autoscaler service broker.");
